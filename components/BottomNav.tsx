...
import { Home, Baby, Activity, Timer, CheckSquare } from "lucide-react";

const navItems = [
  { href: "/", label: "Accueil", icon: Home },
  { href: "/baby", label: "Bébé", icon: Baby },
  { href: "/tracking", label: "Suivi", icon: Activity },
  { href: "/contractions", label: "Contraction", icon: Timer },
  { href: "/checklist", label: "Liste", icon: CheckSquare },
];
