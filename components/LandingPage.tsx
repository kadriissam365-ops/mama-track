...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 via-white to-purple-50 dark:from-[#0f0f1a] dark:via-[#0f0f1a] dark:to-purple-950/20 overflow-x-hidden">
      ...
      {/* Navbar */}
      <nav className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-pink-100 dark:border-pink-900/30">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-[#3d2b2b] dark:text-gray-100 text-lg tracking-tight">MamaTrack</span>
          </div>
      ...
      <section className="relative px-4 pt-20 pb-24 text-center max-w-3xl mx-auto">
        ...
        <motion.p
          ...
          className="mt-6 text-xs text-gray-400 dark:text-gray-500 flex items-center justify-center gap-1.5"
        >
      ...
      <section className="px-4 py-6 max-w-3xl mx-auto -mt-8">
        <motion.div
          ...
          className="bg-white dark:bg-gray-900 rounded-3xl border border-pink-100 dark:border-pink-900/30 shadow-lg shadow-pink-100/30 p-8"
        >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {weekPreviewData.map((item, i) => (
            <motion.div
              ...
              className="bg-white dark:bg-gray-900 rounded-3xl p-5 border border-pink-100 dark:border-pink-900/30 shadow-sm hover:shadow-lg hover:border-pink-200 dark:border-pink-800/30 transition-all text-center group"
            >
              <motion.span
              ...
              <p className="text-sm font-bold text-[#3d2b2b] dark:text-gray-100">{item.fruit}</p>
              <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">{item.size}</p>
            </motion.div>
          ))}
        </div>
      </section>
          ...
          {features.map((f, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white dark:bg-gray-900 rounded-2xl p-4 sm:p-5 border border-pink-100 dark:border-pink-900/30 shadow-sm hover:shadow-md hover:border-pink-200 dark:border-pink-800/30 transition-all group"
              >
      ...
      <section className="px-4 py-20 max-w-3xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true, margin: "-50px" }}
          variants={sectionVariants}
          className="relative bg-gradient-to-br from-pink-100 via-purple-50 to-emerald-50 dark:from-pink-950/40 dark:via-purple-950/30 dark:to-emerald-950/20 rounded-[2rem] p-8 sm:p-12 border border-pink-100 dark:border-pink-900/30 overflow-hidden"
        >
          <div className="flex flex-col sm:flex-row items-center gap-8">
            <div className="flex-1 text-center sm:text-left">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#3d2b2b] dark:text-gray-100 mb-4">
              ...
              <div className="w-64 bg-[#0d0d1a] rounded-[2.5rem] shadow-2xl shadow-pink-200/40 border-[3px] border-gray-700 p-3 relative">
                ...
                <div className="bg-gradient-to-b from-pink-50 to-white rounded-[2rem] p-4 pt-6 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-pink-50 dark:bg-pink-950/30 rounded-xl p-2.5 text-center">
                      <p className="text-[10px] text-gray-400 dark:text-gray-500">Poids</p>
                      <p className="text-sm font-bold text-[#3d2b2b] dark:text-gray-100">65.2 kg</p>
                    </div>
                    <div className="bg-purple-50 dark:bg-purple-950/30 rounded-xl p-2.5 text-center">
                      <p className="text-[10px] text-gray-400 dark:text-gray-500">Eau</p>
                      <p className="text-sm font-bold text-[#3d2b2b] dark:text-gray-100">1.5 L</p>
                    </div>
                  </div>
                  <div className="bg-emerald-50 dark:bg-emerald-950/30 rounded-xl p-2.5">
                    <p className="text-[10px] text-gray-400 dark:text-gray-500">Prochain RDV</p>
                    <p className="text-xs font-semibold text-[#3d2b2b] dark:text-gray-100">Echo T2 - 15 mai</p>
                  </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {differentiators.map((d, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: i * 0.1 }}
              className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-purple-100 dark:border-purple-900/30 shadow-sm flex items-start gap-4 hover:shadow-md hover:border-purple-200 dark:border-purple-800/30 transition-all"
            >
      ...
      <section className="px-4 py-20 max-w-3xl mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-1 mb-3">
            ...
            <span className="ml-2 text-sm font-bold text-[#3d2b2b] dark:text-gray-100">4.7</span>
            <span className="text-xs text-gray-400 dark:text-gray-500 ml-1">({testimonials.length} avis)</span>
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold text-[#3d2b2b] dark:text-gray-100 mb-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: i * 0.1 }}
              className="relative bg-white dark:bg-gray-900 rounded-3xl p-6 border border-pink-100 dark:border-pink-900/30 shadow-sm hover:shadow-md transition-all overflow-hidden"
            >
              {/* Gradient accent bar */}
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="text-sm font-bold text-[#3d2b2b] dark:text-gray-100">{t.name}</p>
                  <p className="text-[11px] text-pink-400 font-semibold">{t.week}</p>
                </div>
                <div className="ml-auto flex gap-0.5">
                  {[...Array(5)].map((_, j) => (
                    <Star key={j} className={`w-3.5 h-3.5 ${j < t.rating ? "text-yellow-400 fill-yellow-400" : "text-gray-200 dark:text-gray-600 fill-gray-200 dark:fill-gray-600"}`} />
                  ))}
                </div>
              </div>
        ...
        <div className="space-y-3">
          {faqItems.map((item, i) => (
            <motion.div
              ...
              className="bg-white dark:bg-gray-900 rounded-2xl border border-pink-100 dark:border-pink-900/30 shadow-sm overflow-hidden"
            >
              <button
              ...
              >
                <p className="px-6 pb-5 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">{item.a}</p>
              </motion.div>
            </motion.div>
          ))}
        </div>
      ...
      <section className="px-4 py-20 pb-10 max-w-3xl mx-auto text-center">
        <motion.div
          ...
          viewport={{ once: true, margin: "-50px" }}
          variants={sectionVariants}
          className="bg-gradient-to-br from-pink-100 via-purple-50 to-emerald-50 dark:from-pink-950/40 dark:via-purple-950/30 dark:to-emerald-950/20 rounded-[2rem] p-10 sm:p-14 border border-pink-100 dark:border-pink-900/30 relative overflow-hidden"
        >
          {/* Decorative circles */}
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#3d2b2b] dark:text-gray-100 mb-4 relative z-10">
            Prete a commencer ?
          </h2>
          <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-10 max-w-md mx-auto relative z-10">
          ...
          <p className="mt-5 text-xs text-gray-400 dark:text-gray-500 relative z-10">
      ...
      <section className="px-4 py-16 max-w-3xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true, margin: "-50px" }}
          variants={sectionVariants}
          className="bg-white dark:bg-gray-900 rounded-3xl border border-pink-100 dark:border-pink-900/30 shadow-lg shadow-pink-100/30 p-8 sm:p-10 text-center"
        >
      ...
      {/* Footer */}
      <footer className="px-4 py-14 max-w-5xl mx-auto border-t border-pink-100 dark:border-pink-900/30 mt-8">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-12">
          ...
          {footerLinks.map((section) => (
            <div key={section.title}>
              <h4 className="text-xs font-bold text-[#3d2b2b] dark:text-gray-100 uppercase tracking-wider mb-3">
                {section.title}
              </h4>
