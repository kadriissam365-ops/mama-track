  ...
  const exports = [
    {
      ...
      icon: Scale,
      color: "text-pink-600",
      bg: "bg-pink-50 dark:bg-pink-950/30 border-pink-200 dark:border-pink-800/30 hover:bg-pink-100 dark:hover:bg-pink-900/30",
      title: "Poids (CSV)",
    ...
    },
    {
      ...
      bg: "bg-violet-50 dark:bg-violet-950/30 border-violet-200 dark:border-violet-800/30 hover:bg-violet-100 dark:hover:bg-violet-900/30",
      title: "Symptômes (CSV)",
    ...
    },
    {
      ...
      bg: "bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800/30 hover:bg-emerald-100 dark:hover:bg-emerald-900/30",
