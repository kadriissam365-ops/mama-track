  ...
  if (permission === "default") {
    return (
      <motion.button
        ...
        className="w-full bg-pink-400 text-white rounded-2xl p-4 flex items-center justify-center gap-3 shadow-sm hover:bg-pink-500 dark:hover:bg-pink-600 dark:bg-pink-500 transition-colors"
      >
