    ...
    >
      ...
      <div className="bg-white dark:bg-gray-900 rounded-3xl p-5 shadow-sm border border-emerald-100">
        ...
        <button
          ...
          className="w-full bg-emerald-400 text-white py-2.5 rounded-xl text-sm font-medium disabled:opacity-50 hover:bg-emerald-500 dark:hover:bg-emerald-500 transition-colors"
        >
