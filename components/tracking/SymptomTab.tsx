  ...
  return (
    ...
    >
      <button
        ...
        className="w-full py-3 bg-pink-400 text-white rounded-2xl font-medium flex items-center justify-center gap-2 hover:bg-pink-500 dark:hover:bg-pink-600 dark:bg-pink-500 transition-colors shadow-sm"
      >
        ...
        {showForm && (
          ...
          >
            ...
            <button
              ...
              className="w-full py-2.5 bg-pink-400 text-white rounded-xl font-medium disabled:opacity-50 hover:bg-pink-500 dark:hover:bg-pink-600 dark:bg-pink-500 transition-colors"
            >
              Enregistrer
            </button>
          </motion.div>
