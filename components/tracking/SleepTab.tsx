    ...
    >
      <div className="bg-white dark:bg-gray-900 rounded-3xl p-5 shadow-sm border border-indigo-100 dark:border-indigo-900/30">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="w-full bg-indigo-400 text-white py-2.5 rounded-xl text-sm font-medium disabled:opacity-50 hover:bg-indigo-500 dark:hover:bg-indigo-500 transition-colors"
        >
