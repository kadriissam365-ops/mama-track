        ...
        >
          ...
          {user && (
            <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-2xl p-4 border border-pink-100">
              <p className="text-xs text-gray-500 mb-1">{t("settings.connectedWith")}</p>
          ...
          <div className="bg-white rounded-3xl p-5 shadow-sm border border-pink-100 space-y-4">
            <h3 className="font-semibold text-[#3d2b2b]">{t("settings.myProfile")}</h3>
          ...
          <div className="bg-white rounded-2xl p-4 border border-gray-100">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">{t("settings.sync")}</span>
              <span
