    ...
    <div className="max-w-lg mx-auto px-4 py-6 space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="w-9 h-9 bg-purple-400 rounded-xl flex items-center justify-center text-white hover:bg-purple-500 dark:hover:bg-purple-600 dark:bg-purple-500 transition-colors"
        >
      ...
      {activeMeds.length === 0 && !showAdd && (
        ...
        >
          ...
          <button
            onClick={() => { setShowAdd(true); setShowPresets(true); }}
            className="bg-purple-400 text-white px-6 py-2.5 rounded-xl text-sm font-medium hover:bg-purple-500 dark:hover:bg-purple-600 dark:bg-purple-500 transition-colors"
          >
              ...
              {!showPresets && (
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full bg-purple-400 text-white py-2.5 rounded-xl text-sm font-medium disabled:opacity-50 hover:bg-purple-500 dark:hover:bg-purple-600 dark:bg-purple-500 transition-colors"
                  >
                    Ajouter
                  </button>
                </div>
