...
const SAFETY_CONFIG: Record<Safety, { icon: typeof ShieldCheck; label: string; bg: string; text: string; border: string }> = {
  ok: { icon: ShieldCheck, label: "Autorisé", bg: "bg-green-50 dark:bg-green-950/30", text: "text-green-600 dark:text-green-400", border: "border-green-200 dark:border-green-800/30" },
  caution: { icon: ShieldAlert, label: "Avec précaution", bg: "bg-yellow-50 dark:bg-yellow-950/30", text: "text-yellow-600 dark:text-yellow-400", border: "border-yellow-200 dark:border-yellow-800/30" },
